...
export class JDB_TRANSACTION_INTERNAL_FAILEDNOENTRY extends JDB_INTERNALERROR {};
export class JDB_DB_INTERNAL_TRANSACTION_FAILINIT_BADDATA extends JDB_INTERNALERROR {};