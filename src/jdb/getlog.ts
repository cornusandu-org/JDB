...
export const codes = Object.freeze({
    ...
    JDB_DB_MKTABLE_F1: "JDB_DB_MKTABLE_F1",
    JDB_DB_MKTABLE_EXISTS: "JDB_DB_MKTABLE_EXISTS",
    JDB_DB_MKTRANSACTION_NOENTRY: "JDB_DB_MKTRANSACTION_NOENTRY",
    JDB_DB_INTERNAL_MKTRANSACTION_MISSINGDATA: "JDB_DB_INTERNAL_MKTRANSACTION_MISSINGDATA",
    JDB_TRANSACTION_INTERNAL_FAILEDTOCOMMIT_NOENTRY: "JDB_TRANSACTION_INTERNAL_FAILEDTOCOMMIT_NOENTRY"
} as const);
